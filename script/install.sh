...
echo
echo '----------- Install EZPhone dependences ----------'
echo
sleep 1
clear
...
clear
echo
echo '----------- Download EZPhone $VERSION  ----------'
echo
sleep 1
mkdir -p /var/www/html/callcenter
cd /var/www/html
git clone https://github.com/magnussolution/EZPhone.git callcenter
...
mysql callcenter -u root -p$password  < /var/www/html/callcenter/script/script.sql
...
rm -rf /var/www/html/callcenter/script/script.sql
clear
