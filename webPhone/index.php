...
<script type="text/javascript">
    var user = window.localStorage.getItem('org.doubango.identity.display_name');
...
<head>
    ...
    <script type="text/javascript">
                ...
                case 'i_new_call':
                    {
                        if (oSipSessionCall) {
                            ...
                            txtCallStatus.innerHTML = "<i><font color='red'>Incoming call from [<b>" + sRemoteNumber + "</b>]</font></i>";
        ...
        function setAutoAnswer(element) {
            window.localStorage.setItem('org.doubango.identity.autoanswer', element.checked);
        }
...
<div id="divCallCtrl" style="width: 680px;  margin-top:7px;">

    <table style=' width:100%; margin-left:-20px; margin-right:-20px; height: 70px'  border=0>

        <tr>
            <td width="25%" align="right"  style=" vertical-align:top">
                <input type="button" class="btn btn-success" id="btnRegister" value="In" disabled onclick='sipRegister();' />
                &nbsp;
                <input type="button" class="btn btn-danger" id="btnUnRegister" value="Out" disabled onclick='sipUnRegister();' />
                <br>
                <label style="color:green;" align="right" id="txtCallStatus"></label>
            </td>
            <td width="45%" style=" vertical-align:top">
                ...
                <table style='width: 100%; height: 70px'>
                    ...
                    <tr>
                        <td colspan="1">
                            <div id='divCallOptions' align="center" style='opacity: 0; margin-top: 0px; height: 10px; margin-top: -35'>
            ...
            <td width="30%" style=" vertical-align:top" >
                <table >
                    <tr >
                        <td>
                            <div class="btn-toolbar" style="margin: 0; vertical-align:top">
                                <div id="divBtnCallGroup" class="btn-group">
                                    <button id="btnCall" disabled class="btn btn-primary" data-toggle="dropdown">Call</button>
                                </div>&nbsp;
                                <div class="btn-group">
                                    <input type="button" id="btnHangUp" style="margin: 0; vertical-align:top; height: 100%;" class="btn btn-primary" value="HangUp" onclick='sipHangUp();' disabled />
                                </div> &nbsp;
                                <input style="margin: 0; vertical-align:top;" id='autoanswer' onchange="setAutoAnswer(this)"  type="checkbox" name="antoanswer" alt="AutoAnswer"><span style="margin-top:-5; vertical-align:top;" >AA</span>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style=" vertical-align:top"> <label style="color:blue;" align="left" id="txtRegStatus"></label></td>
                    </tr>
                </table>
    ...
    <div id="divVideo" class='div-video' style="display: none;">
...
<div style="display: none2">
    ...
    <!-- KeyPad Div -->
    <div id='divKeyPad' class='span2 well div-keypad' style="left:0px; top:-20px; width:500; height:100; visibility:hidden">
        <table style="width: 100%;">
            <tr align="center">
                <td>
                    <input type="button" style="width: 50px" class="btn" value="1" onclick="sipSendDTMF('1');" />
                    <input type="button" style="width: 50px" class="btn" value="2" onclick="sipSendDTMF('2');" />
                    <input type="button" style="width: 50px" class="btn" value="3" onclick="sipSendDTMF('3');" />
                    <input type="button" style="width: 50px" class="btn" value="4" onclick="sipSendDTMF('4');" />
                    <input type="button" style="width: 50px" class="btn" value="5" onclick="sipSendDTMF('5');" />
                    <input type="button" style="width: 50px" class="btn" value="6" onclick="sipSendDTMF('6');" />
                    <input type="button" style="width: 50px" class="btn" value="7" onclick="sipSendDTMF('7');" />
                    <input type="button" style="width: 50px" class="btn" value="8" onclick="sipSendDTMF('8');" />
                    <input type="button" style="width: 50px" class="btn" value="9" onclick="sipSendDTMF('9');" />
                </td>
            </tr>
            <tr align="center">
                <td>
                    <input type="button" style="width: 70px" class="btn" value="*" onclick="sipSendDTMF('*');" />
                    <input type="button" style="width: 100px" class="btn" value="0" onclick="sipSendDTMF('0');" />
                    <input type="button" style="width: 70px" class="btn" value="#" onclick="sipSendDTMF('#');" />
                    <input type="button" style="width: 50px" class="btn btn-medium btn-danger" value="close" onclick="closeKeyPad();" />
                </td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        if (window.localStorage.getItem('org.doubango.identity.autoanswer') == 'true') {
            document.getElementById('autoanswer').checked = 1;
        }
