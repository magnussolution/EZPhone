Ext.define('Ext.ux.form.field.Lookup', {
    ...
    onClickSearch: function(btn, e) {
        ...
        if(!me.windowSearch) {
            ...
            me.windowSearch = Ext.widget('window', Ext.apply({
                ...
                draggable: false,
                baseCls: 'x-panel',
                width: me.rawField.getWidth() + 23 + me.startX ,
                height: window.isTablet ? 300 : 400,
                items: me.list,
                bbar: ['->', {
                    text: t('Cancel'),
                    glyph: icons.stop,
            ...
            me.windowSearch.setWidth(me.rawField.getWidth())
        }
    ...
    onShowWindowSearch: function(win) {
        ...
        !me.list.store.getCount() && Ext.defer(function(){me.list.store.load()}, 10);
    },
